              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-bs-toggle="dropdown">
                  <div class="navbar-profile">
                    ...
                    <p class="mb-0 d-none d-sm-block navbar-profile-name">Tamu</p>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <center>
              ...
              <H2 style="font-size: 50px;">DI SIZAKAT</H2>
              <br>
        
              <button type="button" class="btn btn-inverse-info btn-fw"  style="font-size: 25px;">MULAI</button>
            </center>
