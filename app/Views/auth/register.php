              ...
              <div class="card-body px-5 py-5">
                ...
                <form action="<?= url_to('register') ?>" method="post">
                  ...
                  <label for="username"><?=lang('Auth.username')?></label>
                    <input type="text" class="form-control p_input <?php if (session('errors.username')) : ?>is-invalid<?php endif ?>" 
                  ...
                  <label for="email"><?=lang('Auth.email')?></label>
                    <input type="email" class="form-control p_input <?php if (session('errors.email')) : ?>is-invalid<?php endif ?>"
                  ...
                  <p class="sign-up text-center"><?=lang('Auth.alreadyRegistered')?> <a href="<?= url_to('login') ?>"><?=lang('Auth.signIn')?></a></p>
                </form>
              </div>
            </div>
          </div>
